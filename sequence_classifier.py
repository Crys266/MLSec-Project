...
from a_ixg import InputXGradientAttributions
from transformers_interpret.errors import (
    AttributionTypeNotSupportedError,
    InputIdsNotCalculatedError,
)

SUPPORTED_ATTRIBUTION_TYPES = ["input_x_gradient"]
...
class SequenceClassificationExplainer(BaseExplainer):
    ...
    This explainer also allows for attributions with respect to a particolarembedding type.
    ...
    def __init__(
        ...
        attribution_type: str = "input_x_gradient",
        ...
        Args:
            ...
            attribution_type (str, optional): The attribution method to calculate on. Defaults to "input_x_gradient".
        ...
        self.attributions: Union[None, InputXGradientAttributions] = None
    ...
    def _calculate_attributions(self, embeddings: Embedding, index: int = None, class_name: str = None):
        ...
        input_x_gradient = InputXGradientAttributions(
        ...
        input_x_gradient.summarize()
        self.attributions = input_x_gradient
